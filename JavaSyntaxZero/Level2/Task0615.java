...
/*
Перед тобой класс Earth - сборник переменных, описывающих определенные
характеристики планеты Земля.
Сделай из переменных класса Earth глобальные константы.
Не забудь переименовать переменные, чтобы они отвечали
...
• Переменную population класса Earth нужно переделать
  в глобальную переменную.
• Переменную equatorLength класса Earth нужно переделать
  в глобальную переменную.
